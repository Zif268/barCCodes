...
fname = os.path.join(dirname, "CC_list_all_5heptads_AQS_hel.csv")
...
fname = os.path.join(dirname, "CC_list_all_5heptads_AQS_hel_filtered.csv")
...
for st in sets:
    ...
    fname = os.path.join(dirname, "CC_list_5heptads_" + str(st) + "_hel_filtered.csv")
